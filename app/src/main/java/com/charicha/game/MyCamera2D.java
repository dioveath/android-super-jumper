...
public class MyCamera2D {
    ...
    public MyCamera2D(GLGraphics glGraphics, float x, float y, float frustumWidth, float frustumHeight){
    ...
    public void setOrthoProjection(){
        ...
        gl.glLoadIdentity();
        gl.glOrthof(this.x - frustumWidth/2 * scalex, this.x + frustumWidth/2 * scalex,
                this.y - frustumHeight/2 * scaley, this.y + frustumHeight/2 * scaley, -1, 1);
    }
